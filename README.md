...
Fig.3: Ellipse fitted to the nucleus mask, rotated to align the main axis with x, with evaluation of the angle between the ellipse main axis (blue) and the guide line (green) - the value "Corr.".
